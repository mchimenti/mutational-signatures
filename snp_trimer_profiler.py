...
snp_tab["minus_one"] = snp_flank_left
snp_tab["plus_one"] = snp_flank_right


time = datetime.datetime.now() - start_time
print "Retrieving Entrez data.  Elapsed Time: ", time 
print "Writing SNP table to CSV File."

snp_tab.to_csv('/Users/mchimenti/iihg/schularick_mut_sig/snp_tab.csv', index=False)
